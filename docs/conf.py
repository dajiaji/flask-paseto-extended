...
nitpick_ignore = [
    ...
    ("py:class", "flask.sessions.SessionInterface"),
    ("py:class", "flask.sessions.SessionMixin"),
    ("py:class", "flask.wrappers.Request"),
    ("py:class", "flask.wrappers.Response"),
    ("py:class", "flask_login.login_manager.LoginManager"),
    ("py:class", "SessionMixin"),
]
